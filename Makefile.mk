GO_MODULE ?= github.com/zxzharmlesszxz/prometheus-domain-exporter
...
PROJECT_NAME ?= prometheus-domain-exporter
PROJECT_DESC ?= Prometheus Domain Exporter
FEATURE_NAME ?= domain
FEATURE_NAMESPACE ?= domain
METRIC_NAMESPACE ?= domain_exporter
DEFAULT_PORT ?= :9853
FEATURE_CONFIG_FILE ?= prometheus-domain-exporter.yml
